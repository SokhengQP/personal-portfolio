...
export default function Header() {
    ...
    return (
        <>
            <div className="relative justify-between gap-8 px-6 py-3 rounded-3xl bg-[#80808072] backdrop-blur-xl flex">
                ...
                <div className="flex items-center justify-center gap-4 cursor-pointer z-10">
